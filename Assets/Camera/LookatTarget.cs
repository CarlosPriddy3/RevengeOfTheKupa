...
namespace UnityStandardAssets.Cameras
{
    public class LookatTarget : AbstractTargetFollower
    {
        ...
        [SerializeField] private Vector3 m_RotationRange;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            if(m_Target != null)
            {
                ...
                float zAngle = Mathf.Atan2(localTarget.y, localTarget.x) * Mathf.Rad2Deg;
                zAngle = Mathf.Clamp(zAngle, m_RotationRange.z * 0.5f, m_RotationRange.z * 0.5f);
                ...
                var targetAngles = new Vector3(m_FollowAngles.x + Mathf.DeltaAngle(m_FollowAngles.x, xAngle),
                                               ...
                                               m_FollowAngles.z + Mathf.DeltaAngle(m_FollowAngles.z, zAngle));
